...
<body style="background-image: url(../img/fondo2.jpg);">
	...
	<script>
		$("#btn-registrar").click(function(){
			var parametros =  `carrera=${$("#carrera").val()}&codigo=${$("#codigo").val()}&seccion=${$("#seccion").val()}&asignatura=${$("#asignatura").val()}&horainicial=${$("#horainicial").val()}&horafinal=${$("#horafinal").val()}&docente=${$("#docente").val()}&edificio=${$("#edificio").val()}&aula=${$("#aula").val()}&dias=${$("#dias").val()}&periodo=${$("#periodo").val()}&uv=${$("#uv").val()}&obs=${$("#obs").val()}`;
			codigo
